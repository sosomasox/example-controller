...
import (
	...
	"github.com/sosomasox/example-controller/generated/example/clientset/versioned/scheme"
...
// ExampleV1alpha1Client is used to interact with features provided by the example.sosomasox.com group.
type ExampleV1alpha1Client struct {
	restClient rest.Interface
}

func (c *ExampleV1alpha1Client) Hoges(namespace string) HogeInterface {
